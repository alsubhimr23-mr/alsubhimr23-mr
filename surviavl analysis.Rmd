---
title: "Survaivl Analysis"
author: "Tawheed , Manar"
date: "2025-12-03"
output:
...
```{r}
dataset <- read.csv("C:\\Users\\s137614\\Downloads\\archive\\veterans_lung_cancer_clinical_trial.csv.csv")
dataset
```
#Kaplan–Meier survival curve comparing treatment groups
```{r}
library(survival)
library(survminer)
